...
- Found in contracts/Trader.sol [Line: 194](contracts/Trader.sol#L194)
...
- Found in contracts/Trader.sol [Line: 154](contracts/Trader.sol#L154)

	```solidity
	  function setFeeMultiplier(uint8 newFeeMultiplier) external onlyOwner {
	```

- Found in contracts/Trader.sol [Line: 164](contracts/Trader.sol#L164)

	```solidity
	  function setAdmin(address newAdmin) external onlyOwner {
	```

- Found in contracts/Trader.sol [Line: 172](contracts/Trader.sol#L172)

	```solidity
	  function withdrawFees() external onlyOwner { // TODO: anyone should be able to call this fn. no need for modifier
	```
...
- Found in contracts/Trader.sol [Line: 219](contracts/Trader.sol#L219)
...
- Found in contracts/Trader.sol [Line: 173](contracts/Trader.sol#L173)
...
- Found in contracts/Trader.sol [Line: 125](contracts/Trader.sol#L125)

	```solidity
	    routers = routers_;
	```

- Found in contracts/Trader.sol [Line: 165](contracts/Trader.sol#L165)
...
- Found in contracts/tests/TestError.sol [Line: 11](contracts/tests/TestError.sol#L11)
...
- Found in contracts/Trader.sol [Line: 123](contracts/Trader.sol#L123)

	```solidity
	  constructor(address vvet_, address[2] memory routers_) {
	```

- Found in contracts/Trader.sol [Line: 134](contracts/Trader.sol#L134)

	```solidity
	    baseGasPrice = params.get(0x000000000000000000000000000000000000626173652d6761732d7072696365);
	```

- Found in contracts/Trader.sol [Line: 156](contracts/Trader.sol#L156)

	```solidity
	    require(newFeeMultiplier <= 30, "Trader: invalid fee multiplier");
	```

- Found in contracts/Trader.sol [Line: 189](contracts/Trader.sol#L189)

	```solidity
	    require(tx.gasprice <= 2 * baseGasPrice, "Trader: gas price too high");
	```

- Found in contracts/Trader.sol [Line: 200](contracts/Trader.sol#L200)

	```solidity
	    uint256 protocolFee = (withdrawAmount - txFee) * feeMultiplier / 10_000;
	```

- Found in contracts/Trader.sol [Line: 207](contracts/Trader.sol#L207)

	```solidity
	    address[] memory path = new address[](2);
	```

- Found in contracts/Trader.sol [Line: 209](contracts/Trader.sol#L209)

	```solidity
	    path[1] = vvet;
	```

- Found in contracts/Trader.sol [Line: 221](contracts/Trader.sol#L221)

	```solidity
	      amountOutExpected * 990 / 1000, // Accept a 1% slippage
	```

- Found in contracts/Trader.sol [Line: 236](contracts/Trader.sol#L236)

	```solidity
	      amountsReceived[amountsReceived.length - 1]
	```

- Found in contracts/Trader.sol [Line: 269](contracts/Trader.sol#L269)
...
- Found in contracts/Trader.sol [Line: 91](contracts/Trader.sol#L91)
