...
describe.skip('Trader.withdraw', function () {
  ...
  //   const { energy, trader, owner, admin, alice, bob, SWAP_GAS } = await fixture()
  ...
  //   expect(contractBalanceVTHO).to.eq(withdrawAmount.sub(gasprice.mul(SWAP_GAS)).mul(3).div(1000))
  // })
  // TODO: test fees
})
